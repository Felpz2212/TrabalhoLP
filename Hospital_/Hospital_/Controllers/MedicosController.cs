...
namespace Hospital_.Controllers
{
    public class MedicosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,nome,email,especialidade")] Medico medico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,nome,email,especialidade")] Medico medico)
        {
            if (id != medico.id)
            {
                return NotFound();
